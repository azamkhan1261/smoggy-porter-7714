...
const cardImages1 = [
  {
    url: "https://images-static.nykaa.com/uploads/fad4269e-a68e-4eca-9244-da27880090c7.jpg?tr=w-600,cm-pad_resize",
  },
  {
    url: "https://images-static.nykaa.com/uploads/42797532-998e-4a6a-9f80-e325a19b3996.jpg?tr=w-600,cm-pad_resize",
  },
];
...
function Home() {
  return (
    <div>
      ...
      <h1 className={styles.bigheader}>ONLY AT BEAUTYZ</h1>
      <div className={styles.card}>
      ...
      <div className={styles.card2}>
        ...
        >
          ...
          <Box p={6}>
            <Stack spacing={0} align={"center"} mb={5}>
              <Text className={styles.tittle}> Beautyz-naturals-all</Text>
            </Stack>
          </Box>
        </Box>
        {/* <Box
