        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid columns={{ base: 1, sm: 2, md: 5 }} spacing={8}>
            <Stack align={'flex-start'}>
              ...
              <ListHeader>
                <Image src={"../images/Beautyz_logo.png"} alt="image" h={"50px"}/>
              </ListHeader>
              ...
              <Links  href={'https://www.nykaa.com/nykaa-csr'}>Beautyz CSR</Links>
            ...
            <Stack align={'flex-start'}>
              <ListHeader fontWeight={"600"} >Help</ListHeader>
              ...
              <Links  href={'https://www.nykaa.com/sellonnykaa'}>Sell on Beautyz</Links>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader fontWeight={"600"} >Inspire Me</ListHeader>
              <Links  href={'https://www.nykaa.com/beauty-blog/?utm_source=Desktop_web_footer'}>Beauty Book</Links>
              <Links  href={'https://nykaatv-web.nykaa.com/?utm_source=Desktop_web_footer'}>Beautyz TV</Links>
              <Links  href={'https://www.nykaa.com/nykaa-network'}>Beautyz Network</Links>
              <Links  href={'https://www.nykaa.com/buying-guides/?utm_source=Desktop_web_footer'}>Buying Guides</Links>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader fontWeight={"600"} >Quick Links</ListHeader>
              ...
              <Links  href={'https://www.nykaaman.com/?utm_source=Desktop_web_footer'}>Beautyz Man</Links>
              <Links  href={'https://www.nykaafashion.com/?utm_source=Desktop_web_footer'}>Beautyz Fashion</Links>
              <Links  href={'https://www.nykaa.com/nykaa-pro?utm_source=Desktop_web_footer'}>Beautyz Pro</Links>
              <Links  href={'https://www.nykaa.com/nfba-nominees-sale-online-2019/?utm_source=Desktop_web_footer'}>Beautyz femina beauty awards winners 2019</Links>
              <Links  href={'https://www.nykaa.com/sitemap?root=nav_footer'}>Sitemap</Links>
            </Stack>
            <Stack align={'flex-start'} >
              <ListHeader fontWeight={"600"} >Top Categories</ListHeader>
