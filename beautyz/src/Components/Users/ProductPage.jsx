    ...
    <Box bgColor={"#f3f3f3"}>
      ...
      >
        <Box bg={"grey"} alignItems={"center"} p={"50px"}>
          ...
          <Text color="pink.500">Read more on Nykaa's Beauty Book{">"}</Text>
        </Box>
        <Box>
          <Image
            h={"320px"}
      ...
      <Box display={"flex"} w={"90%"} m={"auto"} gap={"10px"}>
        <Box flex={1} border={"1px solid grey"}>
          ...
          <Box gap={"20px"} display={"grid"}>
            <Text fontWeight={"600"}>
              SortBy Price : <Button colorScheme={"pink"}  variant='outline'>Low to High</Button>
            </Text>
            <Text fontWeight={"600"}>
              SortBy Price : <Button colorScheme={"pink"}  variant='outline'>High to Low</Button>
            </Text>
            <Text fontWeight={"600"}>
              SortBy Rating : <Button colorScheme={"pink"}  variant='outline'>High to Low</Button>
            </Text>
          </Box>
        </Box>
        <Box
        ...
        >
          {data?.data?.map((item) => (
            ...
            >
              ...
              <Button colorScheme={"pink"} w={"200px"}>Add to Bag</Button>
